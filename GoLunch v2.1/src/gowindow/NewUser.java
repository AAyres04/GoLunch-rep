...
public class NewUser extends JFrame {
    ...
    public NewUser(){
        ...
        inputNuevoUsuario.setBounds(90,40,150,20);
        inputContraseñaNuevoUsuario.setBounds(90,75,150,20);
        create.setBounds(50,100,80,20);
        salir.setBounds(150,100,80,20);
    
        newUserPanel.add(create);
        newUserPanel.add(inputNuevoUsuario);
        newUserPanel.add(inputContraseñaNuevoUsuario);
        ...
        create.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    String usertxter = " ";
                    String passtxter = " ";
                    String punamer = inputNuevoUsuario.getText();
                    String ppaswder = inputContraseñaNuevoUsuario.getText();
                    while (scan.hasNext()) {
     ...
     * @return 
     */
    private String LeerUltimaLineaDeTxt( File file ) {
